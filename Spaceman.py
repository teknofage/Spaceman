...
#                 secret_word.append(item)  # adds it to the checklist


#             def read(index):  # reads the items at each index
#                 item = secret_word[index]
#             return item


#             def update(index, item):  # replaces index with item
#                 secret_word[index] = item


#             def destroy(index):  # destroys whatever is at this index
#                 secret_word.pop(index)
            
#             return str(secret_word, letters guessed):
#         else:
#             return False
